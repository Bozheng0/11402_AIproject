...
from ai_server.sentiment.core.inference_engine import FinalEvaluator
...
def run_test_suite():
    ...
    test_data = {
        "情感傳承類 (預期: 保留)": [
            ...
            "這是外婆留下來的手寫食譜，裡面有她特製滷肉的秘方。",
            "這隻舊泰迪熊是我五歲生日收到的禮物，陪我度過了很多孤單的夜晚。"
        ],
        "身分成就類 (預期: 保留)": [
            "這是我大學畢業時拿到的校長獎獎牌。",
            "這是我為了創業跑的第一張訂單發票，對我來說很有意義。",
            "這套西裝是我第一次升職面試時穿的，它是我的幸運物。"
            "這是我第一次跑完半程馬拉松拿到的完賽獎牌，證明了我的毅力。",
            "這是當年熬夜好幾個月才申請到的專利證書，是我專業能力的象徵。"
        ],
        "負面情緒與壓力類 (預期: 斷捨離)": [
            ...
            "這個杯子裂了一條縫，每次用它都提心吊膽。",
            "這是前任留下來的牙刷，看了就覺得礙眼。"
            "這是準備了好幾年卻落榜的考試用書，現在看到它只會讓我感到深深的挫敗。",
            "這是生重病住院時戴的塑膠手環，一看到就會回想起那段痛苦折磨的日子。"
        ],
        "純粹囤積類 (預期: 斷捨離)": [
            "這個紙箱看起來很堅固，以後搬家說不定能用到。",
            "這堆舊數據線雖然暫時沒用，但萬一以後哪台設備要插呢？",
            "去年買的健身器材，雖然現在都拿來掛衣服，但我總覺得以後會練。"
            "這些是去住飯店拿回來的免費洗髮精，雖然堆了三年都沒用，但覺得總有一天旅行會用到。",
            "這堆洗乾淨的空玻璃罐我一直捨不得丟，想說以後說不定可以拿來裝手工果醬。"
        ],
        "雜物類 (預期: 斷捨離)": [
            "這是一個剛喝完的礦泉水瓶。",
            "去年的舊報紙，上面都是廣告。",
